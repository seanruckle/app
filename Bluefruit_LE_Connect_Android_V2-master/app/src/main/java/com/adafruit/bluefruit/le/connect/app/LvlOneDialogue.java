...
public class LvlOneDialogue extends Fragment  {
    UartAdapter uart = new UartAdapter();
    public static LvlOneDialogue newInstance() {
        return new LvlOneDialogue();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.content_lvl_one_dialogue, container, false);
    }
