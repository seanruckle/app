...
public class PeripheralModulesFragment extends ConnectedPeripheralFragment {
    ...
    private final static int HIKE_ALERT = 2;
    ...
    private void onModuleSelected(int moduleId) {
        ...
        switch (moduleId) {
            ...
            case HIKE_ALERT:
                fragment = HikeAlertFragment.newInstance();
                break;
    ...
    private static class ModulesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private int[] getMenuItems() {
            if (mConnectionMode == CONNECTIONMODE_MULTIPLEPERIPHERAL) {
                return new int[]{MODULE_UART, HIKE_ALERT};
                ...
                return new int[]{MODULE_INFO, MODULE_UART, HIKE_ALERT};
//                if (hasUart && hasDfu) {
//                    return new int[]{MODULE_INFO, MODULE_UART, HIKE_ALERT, MODULE_PINIO, MODULE_CONTROLLER, MODULE_NEOPIXEL, /*MODULE_CALIBRATION,*/ MODULE_THERMALCAMERA, MODULE_DFU};
//                } else if (hasUart) {
//                    return new int[]{MODULE_INFO, MODULE_UART, HIKE_ALERT, MODULE_PINIO, MODULE_CONTROLLER, /*MODULE_CALIBRATION, */MODULE_THERMALCAMERA};
//                } else if (hasDfu) {
